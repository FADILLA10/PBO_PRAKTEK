 ...
 * @author HP
 */
public class LATIHAN_BukuAlamat {
    /*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 */
    ...
    {
        LATIHAN_EntryBukuAlamat[] dba = new LATIHAN_EntryBukuAlamat[100];
        ...
        try{
            while (pil != 5) {
                ...
                switch (pil) {
                    case 1 :
                        LATIHAN_EntryBukuAlamat input = new LATIHAN_EntryBukuAlamat();
                    ...
                    case 2:
                        ...
                        for (int i=del;i<idx;i++){
                            LATIHAN_EntryBukuAlamat temp = dba[i];
                            dba[i] = dba[i+1];
                            dba[i+1]= temp;
                        }
                        idx--;
