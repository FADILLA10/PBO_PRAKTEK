 ...
 */
package FADILLA_2101092006_UTS_A;
...
class class_hotel {
 public static void main (String [] args) throws IOException{
  ...
  //input
  System.out.println("---- PEMESANAN KAMAR DIHOTEL LAKSANA ----");
  
  System.out.println("\nPilih Jenis Kamar");
  System.out.println("1. Kamar Biasa Rp 6000.000/hari");
  System.out.println("2. Kamar VIP Rp 700.000/hari");
  System.out.print("Jenis kamar yang ingin dipesan \t: ");
  ...
  //output
  System.out.println("\n\n------ NOTA PEMBAYARAN HOTEL LAKSANA ------");
  System.out.println("Jenis Kamar yang dipilih \t\t\t: " + kamar);
